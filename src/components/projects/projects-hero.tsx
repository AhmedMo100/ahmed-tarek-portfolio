...
/**
 * @file projects-hero.tsx
 * @package src/components/projects
 * @description
 * Premium Projects page hero introducing the project collection
 * with localized content and an engineering-focused visual identity.
 */
...
/**
 * Premium Projects page hero.
 *
 * Features:
 *
 * • Localized projects introduction
 * • Clean typography-focused content area
 * • Wide projects terminal visual
...
export function ProjectsHero() {
    ...
    return (
        <section className="relative flex min-h-[85vh] items-center overflow-hidden px-4 py-20 md:py-24 lg:py-28">
